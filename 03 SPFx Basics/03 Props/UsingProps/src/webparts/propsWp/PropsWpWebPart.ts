...
import styles from "./PropsWpWebPart.module.scss";
import * as strings from "PropsWpWebPartStrings";
import { SPHttpClient, SPHttpClientResponse } from "@microsoft/sp-http";

export interface IPropsWpWebPartProps {
  description: string;
  labelField: string;
  textboxField: string;
...
export default class PropsWpWebPart extends BaseClientSideWebPart<
  IPropsWpWebPartProps
> {
